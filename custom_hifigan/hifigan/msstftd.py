...
class NormConv2d(nn.Module):
    """Conv2d with normalization (weight_norm / spectral_norm)."""
    def __init__(self, in_channels: int, out_channels: int, kernel_size: tp.Union[int, tp.Tuple[int, int]],
                 stride: tp.Union[int, tp.Tuple[int, int]] = 1, padding: tp.Union[int, tp.Tuple[int, int]] = 0,
                 dilation: tp.Union[int, tp.Tuple[int, int]] = 1, groups: int = 1, bias: bool = True,
                 norm: str = 'weight_norm'):
        super().__init__()
        self.conv = CONV_NORMALIZATIONS[norm](
