...
NGPUS=6
QPS=3 
OUT_PATH=$ROOT/exp/mms-llama/1759h_german_finetune6GPU
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5 fairseq-hydra-train \
    ...
    dataset.max_tokens=600 \
    hydra.run.dir=${OUT_PATH} \
    common.user_dir=${SRC_PTH} \
    common.seed=1 \
    common.empty_cache_freq=50 \
