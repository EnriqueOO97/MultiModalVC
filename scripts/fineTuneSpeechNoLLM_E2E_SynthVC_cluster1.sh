#!/bin/bash
#
# End-to-End Speech Synthesis Training: Stage 1 + HiFi-GAN (SynthVC Variant)
#
...
NGPUS=1
QPS=3
OUT_PATH=$ROOT/exp/mms-speech-NoLLM-E2E-SynthVC/e2e_96G_cross-att_MD_av50_vo50_noise75
...
echo "Running E2E Speech Training (Stage 1 + HiFi-GAN SynthVC Variant)..."
...
CUDA_VISIBLE_DEVICES=0 fairseq-hydra-train \
    ...
    +criterion.use_discriminator=false \
    criterion.mel_loss_weight=1.0 \
    criterion.conv_loss_weight=100.0 \
